...
/* select each card by id and assign to variables*/
...
// variabls are declared globally
...
function startQuiz(){
    ...
    //assign 0 to current question when start button is clicked, then display the current question on the page
    currentQuestion = 0;
    displayQuestion();
...
//behaviour when an answer button clicked: Click event bubbles up to div with id "quiz-option"
//eventObject.target identifies thre specific button element that was clicked on
